  ...
  dashboardHeader(
    ...
    tags$li(
      ...
      tags$li(class = "dropdown",
            tags$a(href="https://github.com/marion-paclot/DECP-app/", target="_blank", 
                   tags$img(height = "30px", alt="Github", src="GitHub-Mark/PNG/GitHub-Mark-64px.png")
            ))
    ...
    sidebarMenu(
      ...
      menuItem("Date d'attribution", tabName = "tab_date", icon = icon("calendar"),
               dateRangeInput('date', "", separator = '-',
                              language = 'fr', start = '2015-01-01'),
               checkboxInput('dateNonRenseignee',
                             "Inclure les marchés avec date d'attribution inconnue", value = FALSE)
      ),
      ...
      menuItem("Lieu d'exécution", tabName = "tab_zoneGeo", icon = icon("map-marker"),
               ...
               checkboxInput('zoneGeoFrance', 'Inclure les marchés France entière', value = FALSE)
      ),
